...
\documentclass[
    ...
    coverstyle=classic
]{AyangThesis} % Refer to the Wiki for a list of available options.
...
\include{Chapters/03-Results-Findings}
\include{Chapters/04-Challenges-and-Limitations}
\include{Chapters/05-Recommendations}
